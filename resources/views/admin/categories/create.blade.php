...
@section('content')
    <div class="container pt-3">
        <form class="py-3 col-md-6 col-lg-5 col-sm-12 m-auto needs-validation" novalidate action="/admin/categories"
            method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="name" type="text" class="form-control" id="nameInput" placeholder="Apple, Samsung,..." required>
                <div class="invalid-feedback">
                    Vui lòng nhập tên danh mục
                </div>
            </div>
            <div>
                <button type="submit" class="btn btn-primary mb-3">Tạo danh mục</button>
