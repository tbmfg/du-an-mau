    ...
    <div class="container pt-3">
        <form class="py-3 row needs-validation" novalidate action="/admin/products" method="POST">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="sale_off" class="form-control" id="inputSale" placeholder="vd: 0" value="0">
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" name="is_special" type="checkbox" id="specialSwitch" checked>
